...
class Oci extends DboSource {
    ...
    public function setCurrentSchema() {
        $this->_execute("ALTER SESSION SET CURRENT_SCHEMA = $this->config['schema']");
    }
    ...
    public function listSources($data = null) {
        ...
        $tables = array();
        $resource = $this->_execute("SELECT owner, table_name FROM all_tables WHERE owner = '$this->config['schema']'");
